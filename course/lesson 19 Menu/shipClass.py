...
class Ship(pygame.sprite.Sprite):
    def __init__(self, character_type, ship_x, ship_y, scale, velocity):
        ...
        self.laser_cooldown = 200           #milliseconds
...
class HealthBar():
    ...
    def __init__(self, healBar_x, helathBar_y, health, max_Health):
        self.healthBar_x = healBar_x
        self.healthBar_y = helathBar_y 
        self.health = health
        self.max_health = max_Health
    
    #create custom draw method
