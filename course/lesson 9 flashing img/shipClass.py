...
class Ship(pygame.sprite.Sprite):
    ...
    def damage_flash(self):
        ...
        elpased = pygame.time.get_ticks() - self.flash_start
        flashing = elpased < self.flash_time * len(self.flash_images)
        ...
        if flashing:
            frame = (elpased // self.flash_time) % len(self.flash_images)
